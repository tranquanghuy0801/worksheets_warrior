    ...
    return (
        <Fragment>
            <div className="flex flex-col w-full space-y-4 md:w-3/12 font-medium">
                <div className="bg-gray-800 flex items-center space-x-2 rounded shadow p-2 text-gray-100">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <span className="text-lg">{data.userDetails ? data.userDetails.firstName + data.userDetails.lastName : ""}</span>
                    </div>
                </div>
                <div className="shadow hidden md:block w-full flex flex-col">
                    ...
                    <hr/>
                    <div onClick={e=> history.push('/wish-list')} className={` px-4 py-4 hover:bg-gray-200 cursor-pointer`}>Favourites</div>
                    <hr/>
